...
const modalStyles = StyleSheet.create({
  ...
  vehicleChipText: { fontSize: 12, fontWeight: '700', color: colors.dark },
...
const styles = StyleSheet.create({
  ...
  wonSub: { fontSize: 12, color: '#065F46', marginTop: 2 },
  card: {
    backgroundColor: colors.card,
    padding: 14,
    borderRadius: 14,
  ...
  body14: { fontSize: 14, color: colors.dark, lineHeight: 20 },
  bodyMuted: { fontSize: 12, color: colors.muted, marginTop: 2, lineHeight: 18 },
